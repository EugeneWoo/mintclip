...
# End-to-End Test: Extract Transcript → Generate Q&A Summary
# Usage: ./test_e2e_qa.sh [video_id]
# Example: ./test_e2e_qa.sh dQw4w9WgXcQ

VIDEO_ID=${1:-"dQw4w9WgXcQ"}  # Default to Rick Astley if no arg provided

echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "End-to-End Test: Transcript → Q&A Summary"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
# Step 2: Generate Q&A summary
echo "Step 2: Generating Q&A summary..."
echo "-----------------------------------"
...
echo "✅ Q&A summary generated successfully"
echo ""
